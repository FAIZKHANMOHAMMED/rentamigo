...
import { Menu, X, Home, PenSquare, User } from "lucide-react"
      ...
      {isMenuOpen && (
        <div className="sm:hidden">
          ...
          <div className="px-4 py-2 flex flex-col space-y-2">
            <Link
              to="/"
              className="px-4 py-2 text-sm font-medium text-black hover:bg-gray-100 rounded-md flex items-center justify-center"
            >
              <Home className="h-5 w-5 mr-1" />
              Home
            </Link>
            ...
            <Link
              to="/dashboard"
              className="px-4 py-2 text-sm font-medium text-white bg-black hover:bg-gray-800 rounded-md flex items-center justify-center"
            >
              <User className="h-5 w-5 mr-1" />
              Dashboard
            </Link>
